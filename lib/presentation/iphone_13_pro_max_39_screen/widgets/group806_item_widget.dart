...
class Group806ItemWidget extends StatelessWidget {
  Group806ItemWidget(this.group806ItemModelObj);

  Group806ItemModel group806ItemModelObj;

  var controller = Get.find<Iphone13ProMax39Controller>();
