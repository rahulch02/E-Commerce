...
class Iphone13ProMax15Screen extends GetWidget<Iphone13ProMax15Controller> {
  @override
                                                                  ...
                                                                  child: Card(
                                                                      ...
                                                                      child: Stack(alignment: Alignment.centerRight, children: [
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.topCenter,
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(55.00), top: getVerticalSize(52.00), right: getHorizontalSize(55.00), bottom: getVerticalSize(52.00)), child: Image.asset(ImageConstant.imgWheat27, height: getSize(128.00), width: getSize(128.00), fit: BoxFit.fill))),
                                                                        Align(
                                                                            alignment:
