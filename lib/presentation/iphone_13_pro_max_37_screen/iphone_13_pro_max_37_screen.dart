import '../iphone_13_pro_max_37_screen/widgets/group1302_item_widget.dart';
import 'controller/iphone_13_pro_max_37_controller.dart';
import 'models/group1302_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:rahul_s_application1/core/app_export.dart';

class Iphone13ProMax37Screen extends GetWidget<Iphone13ProMax37Controller> {
  @override
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                              Padding(padding: EdgeInsets.only(left: getHorizontalSize(1.91), right: getHorizontalSize(2.87), bottom: getVerticalSize(7.05)), child: Switch(value: false, inactiveTrackColor: ColorConstant.whiteA700, onChanged: (rating) {}))
                                                                            ])))
                                                                  ])),
                                                          Container(
                                                              height:
                                                                  ...
                                                                  child: Stack(children: [
                                                                    Align(
                                                                        ...
                                                                        child: Padding(
                                                                            ...
                                                                            child: Image.asset(ImageConstant.imgShoppingcart12, height: getSize(21.00), width: getSize(21.00), fit: BoxFit.fill)))
                                                                  ])))
                                                        ])),
                                                Container(
                                                    height:
                                                                            ...
                                                                            Align(
                                                                                ...
                                                                                child: Container(
                                                                                    ...
                                                                                    child: Obx(() => ListView.builder(
                                                                                        ...
                                                                                        itemCount: controller.iphone13ProMax37ModelObj.value.group1302ItemList.length,
                                                                                        itemBuilder: (context, index) {
                                                                                          Group1302ItemModel model = controller.iphone13ProMax37ModelObj.value.group1302ItemList[index];
                                                                                          return Group1302ItemWidget(model);
                                                                                        }))))
                                                                          ]))))
                                                            ]))
                                                  ]))
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          padding: EdgeInsets.only(
                                              bottom: getVerticalSize(1.00)),
                                          child: Image.asset(
                                              ImageConstant.imgShoppingcartw13,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill))),
                                  Padding(
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          ...
                                          child: Image.asset(
                                              ImageConstant.imgFemaleprofile13,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill)))
                                ]))
