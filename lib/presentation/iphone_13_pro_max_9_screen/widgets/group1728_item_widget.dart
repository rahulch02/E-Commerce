...
class Group1728ItemWidget extends StatelessWidget {
  Group1728ItemWidget(this.group1728ItemModelObj, {this.onTapGroup});

  Group1728ItemModel group1728ItemModelObj;

  var controller = Get.find<Iphone13ProMax9Controller>();
