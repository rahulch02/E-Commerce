import '../iphone_13_pro_max_20_screen/widgets/group1356_item_widget.dart';
...
class Iphone13ProMax20Screen extends GetWidget<Iphone13ProMax20Controller> {
  @override
                                                                                ...
                                                                                Container(
                                                                                    ...
                                                                                    child: Card(
                                                                                        ...
                                                                                        child: Stack(children: [
                                                                                          Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(15.00), top: getVerticalSize(9.00), right: getHorizontalSize(15.00), bottom: getVerticalSize(8.00)), child: Image.asset(ImageConstant.imgSearch14, height: getSize(15.00), width: getSize(15.00), fit: BoxFit.fill)))
                                                                                        ])))
                                                                              ]))))
                                                                ]))),
                                                    Container(
                                                                                                          ...
                                                                                                          Align(
                                                                                                              ...
                                                                                                              child: Container(
                                                                                                                  ...
                                                                                                                  child: Card(
                                                                                                                      ...
                                                                                                                      child: Stack(children: [
                                                                                                                        Align(alignment: Alignment.bottomRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), top: getVerticalSize(10.00), right: getHorizontalSize(1.90), bottom: getVerticalSize(2.39)), child: Image.asset(ImageConstant.imgMinus28, height: getVerticalSize(10.37), width: getHorizontalSize(12.42), fit: BoxFit.fill)))
                                                                                                                      ]))))
                                                                                                        ]))),
                                                                                                Align(
                                                                                                    ...
                                                                                                    child: Container(
                                                                                                        ...
                                                                                                        child: Card(
                                                                                                            ...
                                                                                                            child: Stack(children: [
                                                                                                              Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(1.91), top: getVerticalSize(2.39), right: getHorizontalSize(10.00), bottom: getVerticalSize(2.40)), child: Image.asset(ImageConstant.imgPlusmath13, height: getVerticalSize(11.16), width: getHorizontalSize(13.37), fit: BoxFit.fill)))
                                                                                                            ]))))
                                                                                              ])))
                                                                                    ]))),
                                                                            Align(
                                                                      ...
                                                                      child: Card(
                                                                          ...
                                                                          child: Stack(children: [
                                                                            Align(
                                                                                ...
                                                                                child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(14.00), top: getVerticalSize(3.00), right: getHorizontalSize(13.00), bottom: getVerticalSize(3.00)), child: Image.asset(ImageConstant.imgShoppingcart13, height: getSize(21.00), width: getSize(21.00), fit: BoxFit.fill)))
                                                                          ])))
                                                                ]))),
                                                    Container(
                                                        height: getVerticalSize(
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(6.00)), child: Image.asset(ImageConstant.imgMinus30, height: getVerticalSize(18.00), width: getHorizontalSize(21.00), fit: BoxFit.fill)),
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                  ...
                                                                                  Padding(padding: EdgeInsets.only(left: getHorizontalSize(2.00), top: getVerticalSize(3.00), right: getHorizontalSize(6.00), bottom: getVerticalSize(4.00)), child: Image.asset(ImageConstant.imgSortdown11, height: getSize(11.00), width: getSize(11.00), fit: BoxFit.fill))
                                                                                ])))
                                                                      ])),
                                                              Container(
                                                                  margin: EdgeInsets.only(
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                  ...
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), bottom: getVerticalSize(2.00)), child: Image.asset(ImageConstant.imgStar76, height: getVerticalSize(11.00), width: getHorizontalSize(16.00), fit: BoxFit.fill)),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), bottom: getVerticalSize(2.00)), child: Image.asset(ImageConstant.imgStar77, height: getVerticalSize(11.00), width: getHorizontalSize(16.00), fit: BoxFit.fill)),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), bottom: getVerticalSize(2.00)), child: Image.asset(ImageConstant.imgStar78, height: getVerticalSize(11.00), width: getHorizontalSize(16.00), fit: BoxFit.fill)),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), bottom: getVerticalSize(2.00)), child: Image.asset(ImageConstant.imgStar79, height: getVerticalSize(11.00), width: getHorizontalSize(16.00), fit: BoxFit.fill)),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), bottom: getVerticalSize(2.00)), child: Image.asset(ImageConstant.imgStar80, height: getVerticalSize(11.00), width: getHorizontalSize(16.00), fit: BoxFit.fill))
                                                                                ]))),
                                                                        Padding(
                                                                            padding: EdgeInsets.only(
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  Group1356ItemModel
                                                                      ...
                                                                      controller
                                                                          .iphone13ProMax20ModelObj
                                                                          .value
                                                                          .group1356ItemList[index];
                                                                  return Group1356ItemWidget(
                                                                      model);
                                                                }))),
                                                    Container(
                                                        height: getVerticalSize(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          padding: EdgeInsets.only(
                                              bottom: getVerticalSize(1.00)),
                                          child: Image.asset(
                                              ImageConstant.imgShoppingcartw14,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill))),
                                  Padding(
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          ...
                                          child: Image.asset(
                                              ImageConstant.imgFemaleprofile14,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill)))
                                ]))
