import '../iphone_13_pro_max_40_screen/widgets/group1245_item_widget.dart';
...
class Iphone13ProMax40Screen extends GetWidget<Iphone13ProMax40Controller> {
  @override
                                                                                        ...
                                                                                        Align(
                                                                                            ...
                                                                                            child: Container(
                                                                                                ...
                                                                                                child: Card(
                                                                                                    ...
                                                                                                    child: Stack(children: [
                                                                                                      Align(alignment: Alignment.bottomRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), top: getVerticalSize(10.00), right: getHorizontalSize(1.90), bottom: getVerticalSize(2.39)), child: Image.asset(ImageConstant.imgMinus21, height: getVerticalSize(10.37), width: getHorizontalSize(12.42), fit: BoxFit.fill)))
                                                                                                    ]))))
                                                                                      ]))),
                                                                              Align(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: Card(
                                                                                          ...
                                                                                          child: Stack(children: [
                                                                                            Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(1.91), top: getVerticalSize(2.39), right: getHorizontalSize(10.00), bottom: getVerticalSize(2.40)), child: Image.asset(ImageConstant.imgPlusmath12, height: getVerticalSize(11.16), width: getHorizontalSize(13.37), fit: BoxFit.fill)))
                                                                                          ]))))
                                                                            ])))
                                                                  ])),
                                                          Container(
                                                                  ...
                                                                  child: Stack(children: [
                                                                    Align(
                                                                        ...
                                                                        child: Padding(
                                                                            ...
                                                                            child: Image.asset(ImageConstant.imgShoppingcart11, height: getSize(21.00), width: getSize(21.00), fit: BoxFit.fill)))
                                                                  ])))
                                                        ])),
                                                Container(
                                                    height:
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Obx(() => ListView.builder(
                                                                                    ...
                                                                                    itemCount: controller.iphone13ProMax40ModelObj.value.group1245ItemList.length,
                                                                                    itemBuilder: (context, index) {
                                                                                      Group1245ItemModel model = controller.iphone13ProMax40ModelObj.value.group1245ItemList[index];
                                                                                      return Group1245ItemWidget(model);
                                                                                    }))))
                                                                      ])))
                                                            ]))
                                                  ]))
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          padding: EdgeInsets.only(
                                              bottom: getVerticalSize(1.00)),
                                          child: Image.asset(
                                              ImageConstant.imgShoppingcartw12,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill))),
                                  Padding(
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Padding(
                                          ...
                                          child: Image.asset(
                                              ImageConstant.imgFemaleprofile12,
                                              height: getSize(23.00),
                                              width: getSize(23.00),
                                              fit: BoxFit.fill)))
                                ]))
